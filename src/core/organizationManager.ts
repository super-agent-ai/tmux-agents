import type { OrganizationUnit, OrgUnitType } from './types';
...
export class OrganizationManager implements Disposable {
    private orgUnits: Map<string, OrganizationUnit> = new Map();

    private readonly _onOrgChanged = new EventEmitter<OrganizationUnit>();
    public readonly onOrgChanged = this._onOrgChanged.event;
