import { ProcessCategory, TmuxPane } from './types';
...
export class ProcessTracker {
    ...
    categorizeProcess(command: string, _paneContent?: string): CategorizeResult {
    ...
    getProcessDescription(command: string): string {
        const trimmed = command.trim();
