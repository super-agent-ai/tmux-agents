...
export class PipelineEngine implements Disposable {

    private pipelines: Map<string, Pipeline> = new Map();
    private activeRuns: Map<string, PipelineRun> = new Map();

    private _onPipelineStatusChanged = new EventEmitter<PipelineRun>();
    public readonly onPipelineStatusChanged = this._onPipelineStatusChanged.event;

    private _onStageCompleted = new EventEmitter<{ runId: string; stageId: string; result: StageResult }>();
    public readonly onStageCompleted = this._onStageCompleted.event;
