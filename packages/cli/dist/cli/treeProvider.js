...
exports.ShortcutsProvider = exports.HotkeyInfoTreeItem = exports.TmuxPaneTreeItem = exports.TmuxWindowTreeItem = exports.TmuxSessionTreeItem = exports.TmuxServerTreeItem = exports.TmuxSessionProvider = void 0;
...
const daemonRefresh_1 = require("./daemonRefresh");
class TmuxSessionProvider {
    constructor(serviceManager, extensionPath) {
        ...
        this.processTracker = new processTracker_1.ProcessTracker();
        this.aiManager = new aiAssistant_1.AIAssistantManager();
        this.rollupService = new activityRollup_1.ActivityRollupService();
        this.hotkeyManager = new hotkeyManager_1.HotkeyManager();
        this.daemonRefresh = new daemonRefresh_1.DaemonRefreshService(() => this.refresh(), this.serviceManager.getDaemonRefreshConfig());
...
function getActivityPriorityColor(priority) {
    switch (priority) {
        case types_1.ActivityPriority.AI_WORKING: return 'terminal.ansiGreen';
        case types_1.ActivityPriority.AI_WAITING: return 'terminal.ansiYellow';
        case types_1.ActivityPriority.BUILDING: return 'terminal.ansiYellow';
        case types_1.ActivityPriority.TESTING: return 'terminal.ansiCyan';
        case types_1.ActivityPriority.INSTALLING: return 'terminal.ansiMagenta';
        case types_1.ActivityPriority.RUNNING: return 'terminal.ansiGreen';
        default: return undefined;
    }
}
class TmuxServerTreeItem extends vscode.TreeItem {
...
exports.TmuxServerTreeItem = TmuxServerTreeItem;
class TmuxSessionTreeItem extends vscode.TreeItem {
    constructor(session) {
        ...
        if (session.activitySummary && session.activitySummary.dominantPriority !== types_1.ActivityPriority.IDLE) {
...
class TmuxWindowTreeItem extends vscode.TreeItem {
    constructor(window, extensionPath, sessionAttached) {
        ...
        // Activity-based coloring
        if (window.activitySummary && window.activitySummary.dominantPriority !== types_1.ActivityPriority.IDLE) {
...
class TmuxPaneTreeItem extends vscode.TreeItem {
    constructor(pane, extensionPath, sessionAttached, windowActive) {
        ...
        if (pane.aiInfo) {
            ...
            const iconName = types_1.AI_STATUS_ICONS[pane.aiInfo.status];
            const colorName = types_1.AI_STATUS_COLORS[pane.aiInfo.status];
        ...
        else if (pane.processCategory && pane.processCategory !== types_1.ProcessCategory.IDLE) {
            // Non-idle process: use process category icons and colors
            const iconName = types_1.PROCESS_CATEGORY_ICONS[pane.processCategory];
            const colorName = types_1.PROCESS_CATEGORY_COLORS[pane.processCategory];
            this.iconPath = new vscode.ThemeIcon(iconName, new vscode.ThemeColor(colorName));
        ...
        if (pane.processCategory && pane.processCategory !== types_1.ProcessCategory.IDLE) {
...
class HotkeyInfoTreeItem extends vscode.TreeItem {
...
exports.HotkeyInfoTreeItem = HotkeyInfoTreeItem;
