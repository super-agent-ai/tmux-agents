import { z } from 'zod';
import { formatAgentList, formatTaskList, formatDashboard, formatAgentOutput, formatSuccess, formatError } from './formatters.js';
// ─── Zod Schemas ───────────────────────────────────────────────────────────
...
async function handleSpawnAgent(args, client) {
    const agent = await client.call('agent.spawn', args);
    return formatSuccess('Agent spawned', agent);
}
async function handleSendPrompt(args, client) {
...
async function handleGetDashboard(args, client) {
