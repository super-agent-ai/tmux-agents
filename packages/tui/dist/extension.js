...
import { AgentRole, TaskStatus, StageType, resolveToggle } from './types';
...
import { checkAutoCloseTimers, markDoneTimestamp } from './autoCloseMonitor';
import { syncTaskListAttachments } from './sessionSync';
...
export function activate(context) {
    ...
    const chatViewProvider = new ChatViewProvider(serviceManager, context.extensionUri, apiCatalog, { orchestrator, teamManager, pipelineEngine, templateManager }, aiManager);
...
If any subtask output shows errors, test failures, or incomplete work, the verdict should be FAIL.`;
    ...
    syncTaskListAttachments(sessionSyncCtx).catch(err => console.warn('tmux-agents: Initial session sync failed:', err));
