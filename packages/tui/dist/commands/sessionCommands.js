...
import { TmuxSessionTreeItem, TmuxWindowTreeItem, TmuxPaneTreeItem, TmuxServerTreeItem } from '../treeProvider';
import { AIProvider } from '../types';
const execAsync = util.promisify(cp.exec);
export function registerSessionCommands(context, ctx) {
    const disposables = [];
    // ── Attach ────────────────────────────────────────────────────────────────
