 ...
 */
export function buildSingleTaskPrompt(t, lane) {
    const sections = [];
 ...
 */
export function buildTaskBoxPrompt(parent, subtasks, lane) {
    const sections = [];
 ...
 */
export function buildBundleTaskPrompt(t, otherTasks, lane) {
    const sections = [];
 ...
 */
export function buildDebugPrompt(lane) {
    const sections = [];
 ...
 */
export function appendPromptTail(prompt, options) {
