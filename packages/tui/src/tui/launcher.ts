 ...
 */
async function launchTmuxHybridTUI(socketPath?: string): Promise<void> {
  try {
 ...
 */
async function launchPureInkTUI(socketPath?: string): Promise<void> {
  try {
